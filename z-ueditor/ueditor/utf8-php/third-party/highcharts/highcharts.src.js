...
(function ($) {
	...
	win.HighchartsAdapter = win.HighchartsAdapter || ($ && {
		...
		fireEvent: function (el, type, eventArguments, defaultFunction) {
			...
			// testing if they are there (warning in chrome) the only option is to editor-test if running IE.
...
function StackItem(axis, options, isNegative, x, stackOption, stacking) {
	...
	// First editor-test the user supplied value, then use the dynamic.
	this.alignOptions = {
